...
namespace FischlWorks_FogWar
{
    ...
    public class csFogWar : MonoBehaviour
    {
       ...
       // [Range(0, 100)]
        [SerializeField] private float fogPlaneHeight = 1;
        [SerializeField] private bool IsFollowHeightSource = false;
        [SerializeField]
        ...
        {
            UpdateFog();
            if (IsFollowHeightSource)
            {
                if (heightSource != null)
                {
                 fogPlaneHeight = heightSource.position.y;
                }
            }
        }
